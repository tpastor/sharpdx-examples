...
namespace PloobsEngine.Modelo
{
    ...
    public class BatchInformation
    {
        ...
        /// <param name="VertexStride">The vertex stride.</param>
        /// <param name="PrimitiveType">Type of the primitive.</param>
        public BatchInformation(int BaseVertex, int NumVertices, int PrimitiveCount, int StartIndex, int StreamOffset, VertexDeclaration VertexDeclaration, int VertexStride, PrimitiveType PrimitiveType =  ANX.Framework.Graphics.PrimitiveType.TriangleList)
        {
            this.BaseVertex = BaseVertex;
            this.NumVertices = NumVertices;
            this.PrimitiveCount = PrimitiveCount;
        ...
        /// </summary>
        public Buffer InstancedVertexBuffer = null;
